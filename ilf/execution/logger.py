    ...
    def trace_log_stack(self, log_idx, stack_pos):
        ...
        if 0x60 <= op <= 0x7f:
            ...
            if stack_pos == -1:
                ...
                value_from_call3, value_from_block3 = self.trace_log_memory(log_idx - 1, args_offset,
            ...
            value_from_call2, value_from_block2 = self.trace_log_memory(log_idx - 1, args_offset,
                                                                        args_offset + args_length)
            value_from_call = (value_from_call0 | value_from_call1 | value_from_call2)
            value_from_block = (value_from_block0 | value_from_block1 | value_from_block2)
